...
public class StableTicksAxis extends ValueAxis<Number> {
	...
	/**
	 * Possible tick spacing at the 10^1 level. These numbers must be &gt;= 1 and
	 * &lt; 10.
	 */
	...
	protected void setRange(Object range, boolean animate) {
		...
		if (animate) {
			...
			keyFrames.setAll(
					new KeyFrame(Duration.ZERO, new KeyValue(currentLowerBound, getLowerBound()),
							new KeyValue(scaleValue, getScale())),
					new KeyFrame(Duration.millis(750), new KeyValue(currentLowerBound, rangeVal.low),
