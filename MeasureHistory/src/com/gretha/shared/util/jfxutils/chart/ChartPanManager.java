...
public class ChartPanManager {
	...
	/**
	 * Sets the {@link AxisConstraintStrategy} to use, which determines which axis
	 * is allowed for panning. The default implementation is
	...
	/**
	 * Sets the mouse filter for starting the pan action. If the filter consumes the
	 * event with {@link Event#consume()}, then the event is ignored. If the filter
	 * is null, all events are passed through. The default filter is
	 * {@link #DEFAULT_FILTER}.
	 */
