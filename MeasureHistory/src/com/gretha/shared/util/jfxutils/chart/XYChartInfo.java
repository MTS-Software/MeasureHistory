...
import static com.gretha.shared.util.jfxutils.JFXUtil.getXShift;
import static com.gretha.shared.util.jfxutils.JFXUtil.getYShift;
...
public class XYChartInfo {
	...
	/**
	 * Constructs the XYChartInfo to find chart information in the reference node's
	 * coordinate system.
	 */
	...
	/**
	 * Given graphical coordinates in the reference's coordinate system, returns x
	 * and y axis value as a point via the {@link Axis#getValueForDisplay(double)}
	 * and {@link Axis#toNumericValue(Object)} methods.
	 */
	...
	public Point2D getDataCoordinates(double x, double y) {
		...
		return new Point2D(xAxis.toNumericValue(xAxis.getValueForDisplay(x - xStart)),
	...
	/**
	 * Returns true if the given x and y coordinate in the reference's coordinate
	 * system is in the chart's plot area, based on the xAxis and yAxis locations.
	 * This method works regardless of the started/stopped state.
	 */
