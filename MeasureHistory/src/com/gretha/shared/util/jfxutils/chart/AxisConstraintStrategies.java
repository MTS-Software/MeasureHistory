...
/**
 * AxisConstraintStrategies contains default implementations of
 * {@link AxisConstraintStrategy}.
 */
public class AxisConstraintStrategies {
	...
	/**
	 * The default strategy restricts to horizontal axis if event is in the X axis,
	 * vertical if in Y axis, else allows both axes.
	 */
	...
	/**
	 * Restricts to horizontal axis if event is in the X axis, vertical if in Y
	 * axis, allows both if in the plot area, or none if in none of those areas.
	 */
