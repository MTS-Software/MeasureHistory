...
package com.gretha.shared.util.jfxutils;
...
public class JFXUtil {
	/**
	 * Find the X coordinate in ancestor's coordinate system that corresponds to the
	 * X=0 axis in descendant's coordinate system.
	 *
	 * @param descendant
	...
	/**
	 * Find the Y coordinate in ancestor's coordinate system that corresponds to the
	 * Y=0 axis in descendant's coordinate system.
	 *
	 * @param descendant
	 *            a Node that is a descendant (direct or indirectly) of the ancestor
	 * @param ancestor
	...
	/**
	 * Make a best attempt to replace the original component with the replacement,
	 * and keep the same position and layout constraints in the container.
	 * <p>
	...
	/**
	 * Creates a "Scale Pane", which is a pane that scales as it resizes, instead of
	 * reflowing layout like a normal pane. It can be used to create an effect like
	 * a presentation slide. There is no attempt to preserve the aspect ratio.
	 * <p>
	 ...
	 * {@link #replaceComponent(Node, Node)} method. The Region's parent must be a
	 * Pane in this case.
	 *
	 * @param region
	 *            non-null Region
	 ...
	 * @param override
	 *            if true, w,h is the region's "100%" size even if the region has an
	 *            explicit preferred width and height set.
	 *
	 * @return the created StackPane, with preferred width and height set based on
	 *         size determined by w, h, and override parameters.
	 */
