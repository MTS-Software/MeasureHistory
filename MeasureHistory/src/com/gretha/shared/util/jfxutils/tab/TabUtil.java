...
package com.gretha.shared.util.jfxutils.tab;
...
public class TabUtil {
	...
	/**
	 * Helper method to create a new tab with the given label and make it draggable
	 * with {@link #makeDraggable}.
	 */
	...
	/**
	 * Makes the specified tab draggable. It can be dragged to a {@link TabPane} set
	 * up by {@link #makeDroppable(TabPane)}. setOnDragDetected on the tab's graphic
	...
	/**
	 * Makes the specified {@link TabPane} a drag target for draggable tabs from
	 * {@link #makeDraggable(Tab)}. setOnDragOver and setOnDragDropped are called on
	 * the pane to handle the event.
	 */
